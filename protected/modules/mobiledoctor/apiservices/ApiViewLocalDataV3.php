...
class ApiViewLocalDataV3 extends EApiViewService {
    ...
    protected function createOutput() {
        ...
        if (is_null($this->output)) {
            $this->results->url = array(
                'sendCodeUrl' => Yii::app()->createAbsoluteUrl('/apimd2/smsverifycode'),
                'loginUrl' => Yii::app()->createAbsoluteUrl('/apimd2/userlogin'),
                'createPatientUrl' => Yii::app()->createAbsoluteUrl('/apimd2/patient'),
                'createPatientfileUrl' => Yii::app()->createAbsoluteUrl('/apimd2/patientfile'),
                'createPatientbooking' =>  Yii::app()->createAbsoluteUrl('/apimd2/patientbooking'),
                'myPatientUrl' => Yii::app()->createAbsoluteUrl('/apimd2/patient'),
                'sendBookingUrl' => Yii::app()->createAbsoluteUrl('/apimd2/sendbooking'),
                'receiveBookingUrl' => Yii::app()->createAbsoluteUrl('/apimd2/receivebooking'),
                'patientinfoUrl' => Yii::app()->createAbsoluteUrl('/apimd2/view', array('model'=>'patientinfo', 'id'=>'')),
                'patientfileUrl' => Yii::app()->createAbsoluteUrl('/apimd2/view', array('model'=>'patientfile', 'id'=>'')),
                'doctorpatientinfoUrl' => Yii::app()->createAbsoluteUrl('/apimd2/view', array('model'=>'doctorpatientinfo', 'id'=>'')),
                'doctorpatientfileUrl' => Yii::app()->createAbsoluteUrl('/apimd2/view', array('model'=>'doctorpatientfile', 'id'=>'')),
                'profileUrl' => Yii::app()->createAbsoluteUrl('/apimd2/profile'),
                'profilefileUrl' => Yii::app()->createAbsoluteUrl('/apimd2/profilefile'),
                'applycontractUrl' => Yii::app()->createAbsoluteUrl('/apimd2/applycontract'),
